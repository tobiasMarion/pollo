 ...
 * a cloud is nearly planar, which here is the normal case — see
 * ./README.md#why-a-jacobi-eigensolver.
 */
 ...
 * part of the answer. Scale is deliberately not fitted — see ./README.md.
 */
