 ...
 * A uniform grid of cells one range wide: a device can only hear something in
 * its own cell or the eight around it, so the sweep is over the crowd's density
