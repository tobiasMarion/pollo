 ...
 * anecdote. The simulator descends every one of its streams from the run's one
 * seed and prints that seed, and the tests in here draw their clouds from it for
 * the same reason.
 */
export class Random {
  private s0: number
