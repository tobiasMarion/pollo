 ...
 * `Float32Array`, the worker's own sweep — the loops work on packed numbers and
 * do not go through here at all.
 */

/**
 * A point in meters. The plain type is declared here and the wire schema that
 * validates it lives in `@pollo/contracts`, because a coordinate is a
 * mathematical object first and a message field second.
 */
